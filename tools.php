<?php
define('UPDATE_PAY_USER_NAME','http://doc.zhifu.com/api/pay/updateOrderPayUsername');
define('RECORD_USER_VISITE_INFO','http://doc.zhifu.com/api/pay/recordVisistInfo');
